---
title: "Building a midrange dual 4090 rig"
toc: true
category: tech
date: 2024-04-14
---
...
* PSU: Super Flower Leadex Platinum 1600W 80+ Platinum* ($278.72)
...
![Picture of a Suprim Liquid X 4090 GPU](https://c1.neweggimages.com/productimage/nb640/14-137-759-34.png)
...
One thing to note, if you look up online, you'll see it supports only 128gb RAM, and you **may** see that 
the RAM I chose here is not compatible with the board! 

A latter BIOS update provided compatibility with 48gb RAM, allowing you to keep that DDR5 dual-RAM efficiency
...
could support that in two slots, I chose to do 2x 48GB. Technically it's possible to upgrade it to 192 GB, 
however for now at least keeping it at 48.

It's DDR5 though, which is not cheap sadly.

### PSU

I started out with a ThermalTake Toughpower TT Premium 1650 W, eventually when things got tough I found it had issues. 
When these 4090 beasts draw a ton of power, the system will just shut down and you're SOL. 

So, scrapped that and went a Super Flower Leadex Platinum 1600W 80+ Platinum. Even though it's 50 W less, 
it's handled the 4090's like a champ. 

My good friend Sanyam Bhutani's wise words (paraphrased):
> Platinum or bust.

The other **super handy** part of these PSU's is they come with 600W power designed for the 4090's!
...
All-in-all this is a sub-$1000 dual-4090 Deep Learning rig. You can still make decent use 
...
For example, while building Sanyam mentioned:

> Even if 1:1 they are the same memory footprint, a Quadro card with 7800 CUDA cores *will* outperform 
